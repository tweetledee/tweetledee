...
## Current Release
- <b>0.3.1</b> : Updated all standard JSON files with the cross site access to your Twitter JSON data from client side JavaScript code (sets the Access-Control-Allow-Origin header to accept all connections). Defaults to off.  Set the flag `$TLD_JS = 1` in the file to activate this function.
